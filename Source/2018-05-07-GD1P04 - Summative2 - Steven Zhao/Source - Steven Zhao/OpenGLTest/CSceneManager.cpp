...
void CSceneManager::init()
{
	...
	CUtility::ReflectionProgram = shaderloader.CreateProgram("Resources/Shaders/VertexShaders/ReflectionVert.txt", "Resources/Shaders/FragmentShaders/ReflectionFrag.txt");
