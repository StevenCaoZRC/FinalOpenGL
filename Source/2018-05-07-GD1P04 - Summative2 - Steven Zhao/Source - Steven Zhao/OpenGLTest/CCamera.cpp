...
{
	m_m4Translate = glm::translate(glm::mat4(), v3_SetTranslation);
	m_m4Rotate = glm::rotate(glm::mat4(), glm::radians(v3_SetRotation.y), glm::vec3(0, 0, 1)); //Z
	m_m4Scale = glm::scale(glm::mat4(), v3_SetScale);
	//Model Matrix
	m_m4Model = m_m4Translate * m_m4Rotate *m_m4Scale;
	...
	//Projection and Camera
	m_m4Proj = glm::perspective(90.0f, (GLfloat)Utility::SCR_WIDTH / (GLfloat)Utility::SCR_HEIGHT, 0.1f, 100.0f);
